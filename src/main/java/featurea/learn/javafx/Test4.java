...
public class Test4 extends Application {
    ...
    public void start(Stage stage) {
        stage.setTitle("Chapter 2 Drawing Shapes");
        Group rootGroup = new Group();
        Scene scene = new Scene(rootGroup, 306, 550, Color.WHITE);
        // Sine wave
        ...
        rootGroup.getChildren().add(cubicCurve);
        // Ice cream cone
        Path path = new Path();
        ...
        rootGroup.getChildren().add(quad);
        // outer donut
        ...
        rootGroup.getChildren().add(donut);
